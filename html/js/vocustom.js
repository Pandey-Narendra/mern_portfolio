...
! function($) {
    ...
    * Skills Filter System
    ...
    // Clone marquee row for seamless loop
    (function initMarqueeClone() {
        const marqueeOriginal = document.getElementById('marquee-1');
        const marqueeClone = document.getElementById('marquee-1-clone');
        
        if (marqueeOriginal && marqueeClone) {
            marqueeClone.innerHTML = marqueeOriginal.innerHTML;
        }
    })();
